...
U_MT(LCTRL, Q),     U_MT(LALT, S),     U_MT(LSHFT, D),    U_MT(LGUI, F),    &kp G,             &kp H,             U_MT(LGUI, J),    U_MT(LSHFT, K),    U_MT(LALT, L),     U_MT(LCTRL, M),     \
...
U_MT(LCTRL, Y),     U_MT(LALT, I),     U_MT(LSHFT, E),    U_MT(LGUI, A),    &kp DOT,           &kp D,             U_MT(LGUI, S),    U_MT(LSHFT, T),    U_MT(LALT, N),     U_MT(LCTRL, B),     \
...
U_MT(LCTRL, A),     U_MT(LALT, R),     U_MT(LSHFT, S),    U_MT(LGUI, T),    &kp D,             &kp H,             U_MT(LGUI, N),    U_MT(LSHFT, E),    U_MT(LALT, I),     U_MT(LCTRL, O),     \
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),     U_MT(LALT, R),     U_MT(LSHFT, S),    U_MT(LGUI, T),    &kp G,             &kp K,             U_MT(LGUI, N),    U_MT(LSHFT, E),    U_MT(LALT, I),     U_MT(LCTRL, O),     \
...
U_MT(LCTRL, A),     U_MT(LALT, O),     U_MT(LSHFT, E),    U_MT(LGUI, U),    &kp I,             &kp D,             U_MT(LGUI, H),    U_MT(LSHFT, T),    U_MT(LALT, N),     U_MT(LCTRL, S),     \
...
U_MT(LCTRL, S),     U_MT(LALT, H),     U_MT(LSHFT, N),    U_MT(LGUI, T),    &kp COMMA,         &kp DOT,           U_MT(LGUI, A),    U_MT(LSHFT, E),    U_MT(LALT, O),     U_MT(LCTRL, I),     \
...
U_MT(LCTRL, A),     U_MT(LALT, S),     U_MT(LSHFT, H),    U_MT(LGUI, T),    &kp G,             &kp Y,             U_MT(LGUI, N),    U_MT(LSHFT, E),    U_MT(LALT, O),     U_MT(LCTRL, I),     \
...
&kp PG_DN,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,      U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
...
U_WH_D,            U_MS_L,            U_MS_D,            U_MS_R,            U_NU,              U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,            \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
...
U_RGB_EFF,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NA,              &u_to_U_MEDIA,     &u_to_U_FUN,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,        U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_RGB_BRI,         \
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              &kp EQUAL,         &kp N4,            &kp N5,            &kp N6,            &kp SEMI,          \
...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              &kp PLUS,          &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp COLON,         \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NA,              &kp SLCK,          &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
...
&kp LCTRL,          &kp LALT,          &kp LSHFT,         &kp LGUI,         U_NU,              U_NU,              &kp LGUI,         &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
