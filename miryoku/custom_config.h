...
&kp EQUAL  &kp N1  &kp N2  &kp N3  &kp N4  &kp N5                 &kp N6  &kp N7  &kp N8  &kp N9  &kp N0  &kp BSLH \
&kp LBKT  K00  K01  K02  K03  K04                 K05  K06  K07  K08  K09  &kp RBKT \
&kp Z  K10  K11  K12  K13  K14                 K15  K16  K17  K18  K19  &kp Q \
&td_shift  K20  K21  K22  K23  K24  XXX       XXX  K25  K26  K27  K28  K29  &td_shift \
               &kp LS(LG(P))  K32  K33  K34       K35  K36  K37  &to 0

#define MIRYOKU_LAYERMAPPING_TAP(...) \
&kp EQUAL  &kp N1  &kp N2  &kp N3  &kp N4  &kp N5                 &kp N6  &kp N7  &kp N8  &kp N9  &kp N0  &kp BSLH \
&kp RBKT  &kp B  &kp Y  &kp O  &kp U  &kp APOS                 &kp SEMI  &kp L  &kp D  &kp W  &kp V  &kp Z \
&kp LBKT  &kp C  &kp I  &kp E  &kp A  &kp COMMA                 &kp PERIOD  &kp H  &kp T  &kp S  &kp N  &kp Q \
&td_shift  &kp G  &kp X  &kp J  &kp K  &kp MINUS  XXX       XXX  &kp FLSH  &kp R  &kp M  &kp F  &kp P  &td_shift \
               &kp LS(LG(P))  &kp DEL  &kp BSPC  &kp RET       &kp TAB  &kp SPC  &kp ESC  &to 0
...
U_LT(U_BUTTON, G), U_MT(RALT, X),     &kp J,             &kp K,             &kp MINUS,            &kp FSLH,             &kp R,             &kp M,         U_MT(RALT, F),   U_LT(U_BUTTON, P),\
U_NP,              U_NP,              U_LT(U_MOUSE, DEL),U_LT(U_NAV, BSPC),U_MT(LSHFT, RET),U_LT(U_SYM, TAB),  U_LT(U_NUM, SPACE), U_LT(U_FUN, ESC),  U_NP,              U_NP
